    ...
    while True:
        try:
            ...
            if len(results) != 0:
                ...
                most_recent_update_text = most_recent_update_text.lower()
                command_list = most_recent_update_text.split(" ")
                    ...
                    if(len(command_list)>=2):
                        ...
                        if(command_list[1]=="set"):
                            if(len(command_list)>=4):
                                if(command_list[2]=="cur_plant_type"):
                                    try:
                                        dbms_address = ('localhost', 6000)
                                        with Client(dbms_address, authkey=b'pw') as conn:
                                            conn.send(["set", "cur_plant_type", command_list[3]])
                                    ...
                                    if(command_list[2]=="light"):
                                        ...
                                        if(len(command_list)>=4):
                                            if(command_list[3]=="on"):
                                                ...
                                                gateway.fan(False)
                                    elif(command_list[2]=="ind_light"):
                                        if(len(command_list)>=4):
                                            if(command_list[3]=="on"):
                                                gateway.indicator_led(True)
                                            elif(command_list[3]=="off"):
                                                gateway.indicator_led(False)
                                    elif(command_list[2]=="valve"):
                                        if(len(command_list)>=4):
                                            if(command_list[3]=="on"):
...
def create_message():
    return datetime.today().strftime('%Y-%m-%d - %H:%M:%S') + ": The water tank needs to be refilled."
